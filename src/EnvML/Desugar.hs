...
desugarModule m = case m of
  ...
  N.MAnno m1 mt ->
    N.MAnno (desugarModule m1) (desugarModuleTyp mt)
...
desugarIntfE ie = case ie of
  ...
  N.ModDecl n s -> N.ModDecl n (desugarTyp s)
